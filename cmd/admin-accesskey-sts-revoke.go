// Copyright (c) 2015-2025 libreFS, Inc.
//
...
EXAMPLES:
  1. Revoke all STS accounts for user "user1"
	 {{.Prompt}} {{.HelpName}} myserver user1 --all
...
// mainAdminAccesskeySTSRevoke is the handle for "lc admin accesskey sts-revoke" command.
